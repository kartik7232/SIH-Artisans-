...
export const cultureAssets = {
  ...
  hero: {
    ...
    description: "Every craft carries generations of sacred knowledge. KarigarSeetu turns your single physical product photo and mother-tongue voice into a world-class digital catalogue, smart pricing, and direct market access.",
