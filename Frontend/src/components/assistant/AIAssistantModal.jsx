  ...
  const [messages, setMessages] = useState([
    {
      sender: 'ai',
      text: lang === 'hi' 
        ? "नमस्ते! मैं आपका कारीगर सेतु व्यावसायिक सहायक हूँ। आप मुझसे मूल्य निर्धारण, अनुवाद, फोटो सुधार या बाज़ार के रुझानों के बारे में कुछ भी पूछ सकते हैं।"
        : "Namaste! I am your KarigarSeetu business advisor. You can ask me in your language about fair pricing, photo improvement, English translations, or B2B buyer leads."
    }
  ]);
