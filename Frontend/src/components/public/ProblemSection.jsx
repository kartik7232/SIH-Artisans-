  ...
  return (
    <section className="problem-section">
      <div className="container">
        ...
        {/* The Core KarigarSeetu Manifesto Banner */}
        <div className="problem-solution-banner">
          <div className="banner-content">
            ...
            <div className="banner-text">
              <h4>The KarigarSeetu Difference</h4>
              <p>
                Traditional SaaS requires typing in English, complex dashboards, and computer literacy. KarigarSeetu empowers the artisan using only <strong>their spoken mother tongue</strong> and a <strong>single smartphone camera tap</strong>.
              </p>
            </div>
          </div>
          <button 
