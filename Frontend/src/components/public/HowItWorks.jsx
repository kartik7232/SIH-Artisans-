...
export default function HowItWorks() {
  ...
  const steps = [
    ...
    },
    {
      ...
      desc: "Published instantly to KarigarSeetu verified artisan marketplace, B2B wholesale matching hub, and GeM/ONDC export packages.",
      ...
      <div className="container">
        <div className="section-header-center">
          ...
          <p className="section-desc">
            A seamless journey designed for zero digital literacy. The artisan holds their craft, speaks in their mother tongue, and KarigarSeetu powers the rest.
          </p>
        </div>
