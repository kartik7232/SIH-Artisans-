...
export default function Header() {
  ...
  const navItems = React.useMemo(() => {
    if (role === 'admin') {
      return [
        ...
        { id: 'finance', label: t('navFinance') || 'Finance & Ledger', icon: IndianRupee, badge: 'Advisor' }
      ];
    }
    if (role === 'buyer') {
      return [
    ...
    return [
      ...
      { id: 'finance', label: t('navFinance') || 'Finance & Ledger', icon: IndianRupee, badge: 'AI Advisor' },
  ...
  const handleLanguageChange = (code, nativeName) => {
    ...
    if (code === 'hi') speak('कारीगर सेतु में आपका स्वागत है', 'hi');
    else if (code === 'ta') speak('காரிகர் சேது உங்களை வரவேற்கிறது', 'ta');
    else if (code === 'te') speak('కారికర్ సేతు కి స్వాగతం', 'te');
    else if (code === 'bn') speak('কারিগর সেতু-তে স্বাগতম', 'bn');
        ...
        <div className="brand-logo-wrap" onClick={() => navigate(userHome)}>
          ...
          <div className="brand-text">
            <div className="brand-title">
              KARIGAR<span className="ai-accent">SEETU</span>
            </div>
            <div className="brand-sub">
              {lang === 'hi' ? 'कारीगर सेतु • प्रामाणिक भारत' : 'Handcrafted India • Direct Artisan Platform'}
            </div>
          </div>
        </div>
