...
export default function ArtisanDashboard() {
  ...
  const financialSummary = React.useMemo(() => {
    return storageService.getFinancialSummary();
  }, []);
      ...
      <div className="container">
        ...
        <div className="dashboard-main-grid">
          ...
          <div className="dashboard-col-primary">
            ...
            {/* Financial Health & Bahi-Khata Card */}
            <div className="card financial-health-card" style={{ borderLeft: '4px solid #C59A3F' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '12px' }}>
                <div>
                  <span className="card-tag">BAHI-KHATA & FINANCIAL HEALTH</span>
                  <h3 style={{ fontSize: '1.25rem', fontFamily: 'var(--font-serif)', marginTop: '4px' }}>
                    {lang === 'hi' ? 'वित्तीय स्थिति एवं डिजिटल बहीखाता' : 'Artisan Financial Health & Khata'}
                  </h3>
                </div>
                <span style={{ 
                  background: '#E8F5E9', 
                  ...
                  {financialSummary.healthScore} / 900 • Bank Ready
                </span>
              </div>

              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '12px', margin: '14px 0' }}>
                <div style={{ background: '#FAF8F4', padding: '10px 14px', borderRadius: '8px' }}>
                  <span style={{ fontSize: '0.76rem', color: '#6B655D', display: 'block' }}>Net Profit</span>
                  <strong style={{ fontSize: '1.2rem', color: '#2E7D32', fontFamily: 'var(--font-serif)' }}>
                    ₹{financialSummary.netProfit.toLocaleString('en-IN')}
                  </strong>
                </div>
                <div style={{ background: '#FAF8F4', padding: '10px 14px', borderRadius: '8px' }}>
                  <span style={{ fontSize: '0.76rem', color: '#6B655D', display: 'block' }}>Profit Margin</span>
                  <strong style={{ fontSize: '1.2rem', color: '#1B2A4A', fontFamily: 'var(--font-serif)' }}>
                    {financialSummary.profitMargin}%
                  </strong>
                </div>
                <div style={{ background: '#FAF8F4', padding: '10px 14px', borderRadius: '8px' }}>
                  <span style={{ fontSize: '0.76rem', color: '#6B655D', display: 'block' }}>PM Vishwakarma</span>
                  <strong style={{ fontSize: '0.9rem', color: '#C59A3F' }}>
                    ₹3L Eligible
                  </strong>
                </div>
              </div>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '14px', flexWrap: 'wrap', gap: '8px' }}>
                <span style={{ fontSize: '0.84rem', color: '#716A60' }}>
                  {financialSummary.transactionCount} entries in verified Khata
                </span>
                <button 
                  className="btn btn-primary"
                ...
                >
                  <IndianRupee size={15} />
                  <span>{lang === 'hi' ? 'वित्तीय सहायक खोलें →' : 'Launch Financial Suite →'}</span>
                </button>
              </div>
            </div>
          </div>
