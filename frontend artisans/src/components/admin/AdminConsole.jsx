      ...
      <div className="container">
        ...
        <div className="admin-header-row">
          <div>
            ...
            <h1 className="serif-title">KarigarAI Central Operations & AI Pipeline Health</h1>
        ...
        <div className="admin-two-col-grid">
          ...
          <div className="card system-logs-card">
            ...
            <div className="terminal-logs-window">
              ...
              <code>[12:04:18] SUCCESS: Listing published to KarigarAI Direct Marketplace</code>
            </div>
          </div>
        </div>
      </div>
