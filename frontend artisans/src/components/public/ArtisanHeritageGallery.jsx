        ...
        <div className="gallery-bottom-split">
          ...
          <div className="hands-creation-feature heritage-glass-card">
            ...
            <div className="hands-content-side">
              ...
              <p>
                The potter’s wheel, the carver’s chisel, the tailor’s needle, and the weaver’s shuttle. KarigarAI is designed around tactile physical tools so low-digital-literacy artisans never have to struggle with keyboard typing.
              </p>
          ...
          <div className="heritage-story-card-wrap heritage-glass-card">
            ...
            <div className="provenance-caption">
              ...
              <p>
                Every craft on KarigarAI is geo-tagged to its historical birthplace. Consumers and B2B buyers can trace each textile back to its loom, its weavers, and its 200+ year historical legacy.
              </p>
              <button 
