      ...
      <div className="container">
        ...
        <div className="ethical-guarantee-card">
          ...
          <div className="guarantee-text">
            <h3>The KarigarAI Fair Trade & Provenance Guarantee</h3>
            <p>
              Every product listed on KarigarAI features an unforgeable digital certificate of authenticity, transparent pricing breakdown, and direct linkage to the verified artisan or Self-Help Group.
            </p>
          </div>
