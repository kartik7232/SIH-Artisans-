...
export default function App() {
  const { currentSurface, openAssistant, isSurfaceAllowed } = useApp();
    ...
    <div className={`karigar-app-root ${isAuth ? 'auth-mode-active' : ''}`}>
      ...
      {!isAuth && (
        <button 
          ...
          title={lang === 'hi' ? "कारीगर AI से पूछें" : "Ask KarigarAI"}
        >
          <Sparkles size={18} />
          <span>{lang === 'hi' ? "कारीगर AI से पूछें" : "Ask KarigarAI"}</span>
        </button>
      )}
