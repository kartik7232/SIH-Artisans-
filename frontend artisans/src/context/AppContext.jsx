...
const AppCoordinator = ({ children }) => {
  ...
  const navigate = useCallback((surface, params = {}) => {
    ...
    const effectiveUser = (storedUser && storedUser.isLoggedIn) ? storedUser : currentUser;
    const role = effectiveUser?.role;
    const isLoggedIn = Boolean(effectiveUser?.isLoggedIn);
  ...
  return (
    <AppContext.Provider value={{
      ...
      isSurfaceAllowed: (surface) => isSurfaceAllowedForRole(surface, currentUser?.role),
      allowedSurfaces: ROLE_PERMISSIONS[currentUser?.role] || [],
