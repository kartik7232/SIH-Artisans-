...
export const ROLE_PERMISSIONS = {
  admin: ['admin', 'admin-catalog', 'admin-rfqs', 'marketplace', 'buyer'],
  artisan: ['artisan', 'studio', 'inventory', 'marketplace', 'onboarding'],
  seller: ['artisan', 'studio', 'inventory', 'marketplace', 'onboarding'],
